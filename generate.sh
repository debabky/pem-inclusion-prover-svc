...
GENERATED="${GOPATH}/src/github.com/debabky/pem-inclusion-prover-svc/resources"
OPENAPI_DIR="${GOPATH}/src/github.com/debabky/pem-inclusion-prover-svc/docs/web_deploy"
